...
class Settings:
    ...
    chromedriver_location = localize_path("TwitterPy", "assets", specific_chromedriver)
    if (not chromedriver_location or not path_exists(chromedriver_location)):
        chromedriver_location = localize_path("TwitterPy", "assets", "chromedriver")
    ...
    # set a logger cache outside the TwitterPy object to avoid
    ...
    WORKSPACE = {"name": "TwitterPy", "path": environmental_variables.get("HOME")}
